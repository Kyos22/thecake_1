@extends('layoutsuser.appbloguser')
@section('main')
                        ...
                        <div class="blog-itm">
                            <div class="blog-inner">
                                ...
                                <div class="blog-img">
                                    ...
                                    <a href="{{url('/pages/bloglistuser/'.$each->id_blog)}}" title=""><img src="{{asset('images/' .$each -> photo)}}" alt="It’s More than Just a Chocolate with Heart Shape" /></a>
                                </div>
                                ...
                                <div class="blog-content">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <a href="{{url('/pages/bloglistuser/'.$each->id_blog)}}" class="btn-secondary"> Read more </a>
                ...
                @endforeach
                    ...
                    <div class="article_categories">
                        ...
                        <ul>
                            ...
                            <li><a href="{{url('/pages/bloguser')}}" title="Show articles tagged article">article</a></li>
