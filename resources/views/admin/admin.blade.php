              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                <div class="mdc-card info-card info-card--success">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight-light pb-2 mb-1 border-bottom">List product</h5>
                    
                    <div class="card-icon-wrapper">
                      <a href="admin/showproduct"><i class="material-icons">dvr</i></a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                <div class="mdc-card info-card info-card--danger">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight-light pb-2 mb-1 border-bottom">List category</h5>
                    
                    <div class="card-icon-wrapper">
                      <a href="/admin/showcategory"><i class="material-icons">attach_money</i></a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                <div class="mdc-card info-card info-card--primary">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight-light pb-2 mb-1 border-bottom">List photo</h5>
                    
                    <div class="card-icon-wrapper">
                      <a href="/admin/showphoto"><i class="material-icons">trending_up</i></a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                <div class="mdc-card info-card info-card--info">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight-light pb-2 mb-1 border-bottom">List blog</h5>
                    
                    <div class="card-icon-wrapper">
                      <a href="/admin/showblog"><i class="material-icons">credit_card</i></a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12" style="display: flex; flex-direction: column; align-items: center; text-align: center;">

              <div >
    <img src="{{asset('images/cakebanner.jpg')}}" alt="">
    <p style="font-family: 'Arial', sans-serif; font-size: 18px; font-weight: bold; margin-top: 10px;">Hello</p>
  </div>
              </div>
