                                        ...
                                        <div id="Facet-2-template--16620970705132__product-grid" class="facets__display pro-itm-inner acnav-list">
                                            ...
                                            <price-range class="facets__price">
                                                <div class="field">
                                                    ...
                                                    <input class="field__input" name="min" id="Filter-Price-GTE" type="number" placeholder="0" min="0" max="100.000">
                                                </div>
                                                <div class="field">
                                                    <label class="field__label" for="Filter-Price-LTE">Max price:</label>
                                                    <input class="field__input" name="max" id="Filter-Price-LTE" type="number" min="0" placeholder="100.000" max="100.000">
                                                </div>
                                            </price-range>
                                        </div>
                                    </details>
                                    ...
                                    <div class="card-bottom-inner">
                                        ...
                                        <div class="card-btn-wrapper">
                                            <div class="no-js-hidden price" id="price-template--16620970705132__product-grid-7838545019116" role="status">
                                                ...
                                                <ins class="price-item--regular">{{ number_format($item->price, 0) }} <span class=wbcur>VND</span></ins>
                                                <del class="price-item--sale">

                                                    {{ number_format($item->price, 0) }} <span class=wbcur>VND</span>
