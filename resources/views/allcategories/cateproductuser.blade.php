                                ...
                                <form method="post" action="{{url('/admin/sortby')}}" id="FacetFiltersForm">
                                    ...
                                    <div class="facet-filters sorting caption">
                                        <div class="facet-filters__field">
                                            ...
                                            <div class="select">
                                                <select name="filterdash" class="facet-filters__sort select__select caption-large nice-select" id="SortBy" aria-describedby="a11y-refresh-page-message" onchange="this.form.submit()">
