                            ...
                            @foreach ($products as $item)
                                <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-card grid__item">
                                    ...
                                    <div class="product-card-image product-img">
                                        <div id="pro-template--16620970705132__product-grid-7838545019116" class="card__media"><a href="/products/espresso-dark-chocolate" title="Espresso Dark Chocolate" class="product__media-item" data-media-id="template--16620970705132__product-grid-7838545019116-30918991511788" tabindex="0">
                                        <img loading="lazy" class="default-img" srcset="/images/{{$item->photo}}" alt="">
                                        </a><a href="/products/espresso-dark-chocolate" title="Espresso Dark Chocolate" class="product__media-item" data-media-id="template--16620970705132__product-grid-7838545019116-30918991380716" tabindex="0">
                                            <img loading="lazy" class="default-img" srcset="/images/{{ $item->photo }}"  alt="">
                                        </a><a href="/products/espresso-dark-chocolate" title="Espresso Dark Chocolate" class="product__media-item" data-media-id="template--16620970705132__product-grid-7838545019116-30918991413484" tabindex="0">
                                            <img loading="lazy" class="default-img" srcset="/images/{{ $item->photo }}"  alt="">
                                    ...
                                    <div id="ProductInfo-template--16620970705132__product-grid-7838545019116" class="card-bottom">
                                        ...
                                        <div class="card-title">
                                            ...
                                            <a href="/products/espresso-dark-chocolate" tabindex="0">{{$item->name_product}}</a>
                                            </h5>
                                        </div>
                                        </div>
                                        ...
                                        <variant-selects class="no-js-hidden" data-section="template--16620970705132__product-grid" data-product="7838545019116" data-url="" data-update-url="false" data-layout="card">
                                            ...
                                            <div class="select select-box">
                                                <label>Flavour:</label>
                                                <select id="Option-template--16620970705132__product-grid-7838545019116-0" class="select__select nice-select" name="options[Flavour]" form="product-form-template--16620970705132__product-grid-7838545019116">
